...
"Where are the people?\" resumed the little prince at last. \"It¡¦s a little lonely in the desert¡K\" \"It is lonely when you¡¦re among people, too,\" said the snake.",
...
"¡Kif you tame me, then we shall need each other. To me, you will be unique in all the world. To you, I shall be unique in all the world¡Kif you tame me, it will be as if the sun came to shine on my life. I shall know the sound of a step that will be different from all the others. Other steps send me hurrying back underneath the ground. Yours will call me, like music, out of my burrow",
...
t1=dt2.microsecond-dt1.microsecond

dt3=datetime.datetime.now()
dic=set(data_list)
print(dic)
dt4=datetime.datetime.now()
t2=dt4.microsecond-dt3.microsecond
print("Pickle Execution time:",t1)
print("Dic Execution time:",t2)